...
| **Test** | [`testing/01-overview.md`](./testing/01-overview.md) (tier specs) · [`testing/08-edge-framework.md`](./testing/08-edge-framework.md) · **plus** the first-principles rewrite in the [hardening plan](./plans/bridge-hardening.md) |
