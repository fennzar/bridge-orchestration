...
NEXT_PUBLIC_ANVIL_RPC=${NEXT_PUBLIC_ANVIL_RPC:-}
NEXT_PUBLIC_API_URL=${NEXT_PUBLIC_API_URL:-${PUBLIC_PROTOCOL:-http}://${PUBLIC_HOST:-127.0.0.1}:7051}
NEXT_PUBLIC_ZEPHYR_DAEMON_RPC=${PUBLIC_HOST:-127.0.0.1}:47767
NEXT_PUBLIC_ANVIL_EXPLORER_URL=${NEXT_PUBLIC_ANVIL_EXPLORER_URL:-${PUBLIC_PROTOCOL:-http}://${PUBLIC_HOST:-127.0.0.1}:${BLOCKSCOUT_PORT:-4000}}
